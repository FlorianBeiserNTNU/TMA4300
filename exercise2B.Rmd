...
post_marginal_xs <- function(index, xgrid_reso){
  # x10 grid
...
post_marginal_x_result = post_marginal_xs(index, xgrid_reso)
...
# marginal hyperparam
INLAtheta = inla.smarginal(result$marginals.hyperpar[[2]])
